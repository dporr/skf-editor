...
// ======
    ...
    setLayout: function(setEditor) {
        ...
        //headerH = 15, fileNavH = 75, tabsBarH = 27, findBarH = 28, toolsBarH = 30;
        //console.log(this.editor.parentNode)
        //console.log(this.content.childNodes)
        //Center elements
        this.center.style.position = "absolute";
        //Wrapping everything here
        //Perhaps this should be moved to a .css file...
        this.content.style.width = this.editor.width =
        this.header.style.width =  this.tabsBar.style.width 
        = this.findBar.style.width = "100%";
        this.files.style.width  = this.center.style.left = "10%";
        this.content.style.height = this.editor.height = "100%";
        
        this.optionsFile.style.width = this.optionsEdit.style.width = 
        this.optionsSettings.style.width = this.optionsHelp.style.width = this.filesW + "px";
...
// =====
    ...
    openCloseDir: function(dir, load) {
        ...
        if (load) {
            ...
            this.iceLoc + "/lib/get-branch.php?location=" + dir.childNodes[1].id + "&csrf=" + this.csrf;
